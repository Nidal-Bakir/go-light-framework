...
UPDATE ON mfa_method FOR EACH ROW EXECUTE PROCEDURE trigger_set_updated_at_column ();
...
UPDATE ON mfa_session FOR EACH ROW EXECUTE PROCEDURE trigger_set_updated_at_column();

CREATE TRIGGER update_pending_mfa_session_updated_at_column BEFORE
UPDATE ON pending_mfa_session FOR EACH ROW EXECUTE PROCEDURE trigger_set_updated_at_column();
